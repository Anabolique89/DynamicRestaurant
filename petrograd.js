...
function showDish(dish){
	...
	copy.querySelector("img").src = `imgs/small/${dish.image}-sm.jpg`;
	//copy.querySelector("div").textContent=dish.longdescription;
	//copy.querySelector(".longdescription").textContent=dish.longdescription;
